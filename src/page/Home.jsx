  ...
  return (<div className="">
    ...
    <Container className='mt-4'>
      <Row>
        ...
        <Col sm={8} className="mt-5"><h1 className="fw-bold">
  Lorem ipsum dolor sit amba
</h1>adipisicing elit. Sequi, porro. Fugit deleniti nobis fugiat laborum unde voluptates quaerat temporibus, sint eius aperiam eum neque labore dolore, necessitatibus veniam itaque dolorem!</Col>
      </Row>
    </Container>
    <h1 className="mt-5 ml-150 fw-bold">
      Daftar Menu kami
    </h1>
    ...
    <Stack direction="horizontal" gap={3}>
      ...
      <div className="p-2">
        ...
        />
        <h5 className="ml-9 mt-2">Bakso Ikan GRT</h5>
      </div>
